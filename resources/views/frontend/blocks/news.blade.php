              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  <figure class="aa-blog-img">                    
                    <a href="{!! url('bai-viet',$item->monngon_url) !!}"><img src="{!! asset('images/monngon/'.$item->monngon_anh) !!}" alt="img"></a>  
                  ...
                  <div class="aa-blog-info">
                    ...
                    <a href="{!! url('bai-viet',$item->monngon_url) !!}" class="aa-read-mor-btn">Xem tiếp <span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
              @endforeach 
