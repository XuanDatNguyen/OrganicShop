<div class="aa-sidebar-widget">
  ...
  <div class="aa-recently-views">
    ...
    @foreach ($product as $item)
      <li>
        <a  href="{!! url('san-pham',$item->slug) !!}" class="aa-cartbox-img"><img alt="img" src="{!! asset('images/products/'.$item->image) !!}"></a>
        <div class="aa-cartbox-info">
          <h3 style="font: 20px arial, sans-serif;"><a  href="{!! url('san-pham',$item->slug) !!}">{!! $item->name !!}</a></h3>
          <p style="color:rgb(230, 0, 0); font:20px arial;">{!! number_format("$item->sale_price",0,",",".") !!} vnđ</p>
        </div>                    
      </li>
    @endforeach                                     
    </ul>
