...
@section('content')
<form action="{!! route('admin.promotion.getAdd') !!}" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
        ...
        <div class="panel panel-green">
            ...
            <div class="navbar-right" style="margin-right:10px;margin-top:-50px;">
                <button type="submit" class="btn btn-primary">Lưu</button><a href="{!! URL::route('admin.promotion.index') !!}" ><i class="btn btn-default" >Hủy</i></a>
            </div>
            </div>
